...
function EditCustomer() {
    ...
    try {
      ...
      if (packageDetails.isUnlimited) {
        ...
        const res = await axios.post(
          `https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/updateCustomerPackage/${id}`,
          {
            selectedPackage,
  ...
  const handleUpdateCustomer = async (e) => {
    ...
    try {
      await axios.post(
        `https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/updateCustomer/${id}`,
        newCustomer
      );
  ...
  const handleDeleteCustomer = async (e) => {
    ...
    try {
      if (window.confirm("Are you sure you want to delete this customer?")) {
        await axios.delete(
          `https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/deleteCustomer/${id}`
        );
  ...
  const handleDeletePackage = async (packageId) => {
    try {
      if (
        ...
        await axios.post(
          `https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/deleteCustomerPackage/${id}`,
          { packageId }
        );
