...
const BedDashboard = ({ setProgress }) => {
  ...
  const fetchBeds = async () => {
    ...
    try {
      const beds = await axios.get(
        "https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/getBeds"
      );
  ...
  const handleCreateBed = async () => {
    ...
    try {
      ...
      await axios.post(
        "https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/createBed",
        {
          newBed,
        }
      );
  ...
  const handleUpdateBed = async () => {
    ...
    const response = await axios.patch(
      `https://island-sun-tanning-back-end-4xb6.vercel.app/api/v1/updateBed/${editingBedId}`,
      newBed
    );
